...
@endsection
@section('action-btn')
    <a href="{{ route('store.subDomain') }}" class="btn btn-sm btn-white bor-radius mb-2">
        {{__('Sub Domain')}}
    </a>
    <a href="{{ route('store.customDomain') }}" class="btn btn-sm btn-white bor-radius mb-2">
        {{__('Custom Domain')}}
    </a>
    <a href="{{ route('store.grid') }}" data-title="{{__('Create New Store')}}" class="btn btn-sm btn-white bor-radius mb-2">
        {{__('Grid View')}}
    </a>
    <a href="#" data-size="lg" data-url="{{ route('store-resource.create') }}" data-ajax-popup="true" data-title="{{__('Create New Store')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle mb-2">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <div class="actions ml-3">
                                ...
                                <a href="#" class="action-item" data-size="lg" data-url="{{route('user.reset',\Crypt::encrypt($usr->id))}}" data-ajax-popup="true" data-title="{{__('Reset Password')}}" data-toggle="tooltip" data-original-title="{{__('Reset Password')}}">
