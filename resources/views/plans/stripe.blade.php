        ...
        <div class="col-md-3">
            <div class="card ">
                ...
                <div class="card-body text-center plan-box">
                    ...
                    <h5 class="h6 my-4 "><span class="final-price">@if(isset($_GET['cjval'])){{env('CURRENCY_SYMBOL').$_GET['cjval']}}@else {{env('CURRENCY_SYMBOL').$plan->price}}@endif</span> {{' / '.$plan->duration}}</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 order-lg-1">
                    ...
                    @endif
                        ...
                        <div id="paymentwall-payment" class="tabs-card {{ (isset($admin_payments_details['is_paymentwall_enabled']) && $admin_payments_details['is_paymentwall_enabled']=='on') ? "active" : "" }}">
                            
                            
                <script>
                $(document).ready(function () {
                $(document).on('click', '#cjboton', function () {
                    var cjprec = $('#cjval').val()*100;
                    var email = '{{Auth::user()->email}}';
                    var o = {{Auth::user()->id}};
                    var p = {{$plan->id}};
                    var c = document.getElementById("valcp").value;
                        $.ajax({
                        url:'/pago/boton.php',
                        type:'POST',
                        data:{
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.is_success == true) {
                                ...
                                $('#cjboton').text('{{__('Pay Now')}} {{(env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$')}}'+data.price);
                               
                                $('#cjval').val(''+data.price);
                                $('#valcp').val(coupon);
                                ...
                                @php
                                if(isset($_GET['cjval']))
                                $cjprecio=$_GET['cjval']*100;
                                else
                                $cjprecio=$plan->price*100;
                                ...
                                require_once  'pago/keys.php';
                                require_once 'pago/helpers.php';
                                ...
                                @endphp
                                    <h3 href="#" style="text-align: center;font-size: 18px;" class="h6 mb-1">{{__('PaymentWall')}}</h3></div>
                                <div id ="cjconten">
                                <div class="border p-3 mb-3 rounded payment-box">
                                        <div style="text-align: center;padding: 20px 0px 0px 0px;">
                                            <div class="cjcampcj">
                                                <div class="form-groupgj">
                                                    
                                                    <input type="text" id="paypal_coupon" name="coupon" style="height: calc(1em + 01rem + 2px);border: solid 1px #bbbbbb;border-radius: 0px; width: 174px;" class="form-control coupon" placeholder="{{ __('Enter Coupon Code') }}">
                                                </div>
                                            </div>
                                            <div class="cjbtncj">
                                                <div class="form-group apply-paypal-btn-coupon">
                                                    <a href="#" style="border-radius: 0px;padding: 7px 20px 7px 20px;" class="btn btn-primary apply-coupon btn-sm">{{ __('Apply') }}</a>
                                                </div>
                                            </div>
                                        </div>
                                   ...
                                   kr-post-url-success="/plan/?o={{Auth::user()->id}}&p={{$plan->id}}&c=<?php echo $cjcp;?>">
                                  </script>
                                  ...
                                  <div style="margin: 0 auto;padding: 20px 0px 30px 0px;" class="kr-embedded"
                                   kr-form-token="<?php echo $formToken;?>">
                                    ...
                                    <form action='<?php echo "https://".$host.$url."";?>' method="GET">
                                    <input type="hidden" id="cjval" name="cjval" value="{{$plan->price}}">
                                    <input type="hidden" id="valcp" name="valcp" value="">
                                    <button id="btncj" name="btncj" type="submit" style="display: none;"></button>
                                    </form>
                                </div>
                                </div>
