...
<!--                     <li class="nav-item ml-4">
                ...
                @if(Auth::user()->type == 'super admin')
                    ...
                    <li class="nav-item ml-4">
                     ...
                     <li class="nav-item ml-4">
                        <a href="#recaptcha-setting" id="recaptcha-setting_tab" class="nav-link" data-toggle="tab" role="tab" aria-controls="home" aria-selected="false">
            ...
            <div class="tab-content">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <i class="fab fa-facebook-f" aria-hidden="true"></i>
                                        {{Form::label('tiktok',__('TikTok Pixel'),array('class'=>'form-control-label')) }}
                                        {{Form::text('tiktokpixel_code',null,array('class'=>'form-control','placeholder'=>'tiktok-pixel'))}}
                                        @error('tiktok')
                                        <span class="invalid-google_analytic" role="alert">
                                         <strong class="text-danger">{{ $message }}</strong>
                                     </span>
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach(\App\Models\Utility::themeOne() as $key => $v)
                                    <div class="col-lg-3 col-md-6 col-sm-12 cc-selector mb-2">
                                   <!--      <div class="mb-3 screen">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row gutters-xs mx-auto justify-content-center" id="{{$key}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                 ...
                                 <div class="form-group col-md-2">
                                            {{Form::label('signup_button',__('Sign Up'),array('class'=>'form-control-label')) }}
                                            <div class="">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" name="signup_button" id="signup_button" {{ Utility::getValByName('signup_button') == 'on' ? 'checked="checked"' : '' }}>
                                    ...
                                    <div id="collapse-2-6" class="collapse" aria-labelledby="heading-2-6" data-parent="#accordion-2">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="paymentwall_public_key">{{ __('Public Key')}}</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="paymentwall_private_key">{{ __('Private Key') }}</label>
                ...
                @if(\Auth::user()->type=='super admin')
                        <div class="tab-pane fade" id="recaptcha-setting" role="tabpanel" aria-labelledby="orders-tab">
                    <div class="col-12">
                            <div class="card-body">
                                <div class="p-3">
