                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="pr-title mb-4">
                            <h3 class=" mt-4 store-title text-primary">{{ __('Cart') }}</h3>
                        </div>
                    </div>

                    <!-- Cart table -->
                    <div class="table-responsive my-cart">
                        <table class="table table-cards table-cart align-items-center">
                            <tbody class="list">
                                @if( !empty($products) )
                                    ...
                                    @foreach( $products['products'] as $key => $product )
                                        @if( $product['variant_id'] != 0 )
                                            <tr class="table-cart-row alert" data-id="{{$key}}">
                                                <td class="table-cart-cell cart-item-image">
                                                    @if(!empty($product['image']))
                                                        <img src="{{asset($product['image'])}}"
                                                            alt="" style="width:66px;">
                                                    @else
                                                        <img src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}"
                                                            alt="" style="width:66px;">
                                                    @endif
                                                </td>
                                                <td class="table-cart-cell cart-item-description" scope="row">
                                                    <div class="media align-items-center">
                                                        <a class="cart-item-title text-dark c-list-title mb-0 cart_word_break"
                                                            href="{{route('store.product.product_view',[$store->slug,$product['id']])}}">
                                                            {{$product['product_name'] .' - '. $product['variant_name']}}
                                                        </a>
                                                    </div>
                                                </td>
                                                <td class="table-cart-cell cart-item-price price">
                                                    <div class="media-body pl-3">
                                                        <span class="font-weight-bold mb-2 t-gray p-title">
                                                            {{__('Price')}}
                                                        </span>
                                                        <div class="lh-100">
                                                ...
                                                <td class="table-cart-cell cart-item-quantity qty-box">
                                                    <span class="font-weight-bold t-gray p-title">
                                                        {{__('Quantity')}}
                                                    </span>
                                                    <div class="count-input" data-id="{{$key}}">
                                                        <input class="qty-minus product_qty" type="button" value="<">
                                                        <input class="bx-cart-qty qty form-control form-control-sm text-center product_qty_input"
                                                            id="product_qty" type="text" value="{{$product['quantity']}}"
                                                            data-id="{{$product['product_id']}}">
                                                        <input class="qty-plus product_qty" type="button" value=">">
                                                    </div>
                                                </td>
                                                <td class="table-cart-cell cart-item-tax">
                                                ...
                                                <td class="table-cart-cell cart-item-total">
                                                    <span class="font-weight-bold t-gray p-title">
                                                        {{__('Total')}}
                                                    </span>
                                                    @php
                                                ...
                                                <td class="table-cart-cell cart-item-actions text-right">
                                        ...
                                        @else
                                            <tr class="table-cart-row alert" data-id="{{$key}}">
                                                <td class="table-cart-cell cart-item-image">
                                                    @if(!empty($product['image']))
                                                        <img src="{{asset($product['image'])}}"
                                                            alt="Image placeholder" style="width:66px;">
                                                    @else
                                                        <img src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}"
                                                            alt="Image placeholder" style="width:66px;">
                                                    @endif
                                                ...
                                                <td class="table-cart-cell cart-item-actions text-right ml-3">
                                                    <div class="actions ml-3">
                                                        <a class="action-item mr-2" href="#!"
                                                            data-toggle="tooltip"
                                                            data-original-title="{{__('Move to trash')}}"
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-6 order-md-2 mb-4 mb-md-0">
                                    <div class="d-flex align-items-center justify-content-md-end">
                                        <span class="h6 text-white d-inline-block mr-3 mb-0">
                                            {{__('Total value')}}:
                                        </span>
                                ...
                                <div class="col-md-6 order-md-1">
                                    <a class="btn btn-white btn-white btn-icon rounded-pill hover-translate-y-n3"
                                    ...
                                    <a class="btn return-shop text-white"
