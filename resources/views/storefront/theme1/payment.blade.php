        ...
        <section class="my-cart-section my-payment-box">
            <div class="container">
                ...
                <div class="row row-grid">
                    ...
                    <div class="card">
                                <div class="box-spacecj">
                                    <div style="text-align: center;padding-bottom: 10px;">
                                        <label class="h6 mb-0 lh-180" for="tcd">{{__('Credit / Debit Card')}}</label>
                                            </div>
                                    <div class="row">
                                        
<?php
if (empty($_POST)) {
//dd("IF IUF IF I F",$_POST);
...
$num=($total+$shipping_price-$coupon_price)*100;
                                            ...
                                            <form class="w3-container w3-display-middle w3-card-4" method="POST" action="{{ route('user.bank_transfer',$store->slug) }}">
                                                ...
                                                <div class="form-group mt-3">
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-sm" id="bank_transfer">{{__('Pay Now')}}</button>
                                                     @else
                                                     <button type="button" class="btn btn-primary btn-sm" id="bank_transferinv">{{__('Pay Now')}}</button>
                                                     @endif
                                                </div>
                                            </form>
                                        </div>
