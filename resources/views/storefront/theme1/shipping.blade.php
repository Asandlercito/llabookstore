                ...
                <div class="row row-grid">
                    <div class="col-xl-8 col-lg-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{Form::email('email',Auth::guard('customers')->user()->email,array('class'=>'form-control','placeholder'=>__('Enter Your Email Address'),'required'=>'required','readonly'=>'true'))}}
                                    @else
                        ...
                        <div class="actions-toolbar py-2 mb-4 shop-title">
                            ...
                            <a class="btn btn-sm btn-primary rounded-pill btn-icon shadow hover-shadow-lg hover-translate-y-n3"   style="color:beige" onclick="billing_data()" id="billing_data" data-toggle="tooltip" data-placement="top" title="Same As Billing Address">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="media align-items-center">
                                                            @if(!empty($product['image']))
                                                                <img alt="Image placeholder" src="{{asset($product['image'])}}" class="" style="width:66px;padding-right: 5px;">
                                                            @else
                                                                <img alt="Image placeholder" src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}" class="" style="width:66px;padding-right: 5px;">
                                                            @endif
