                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 banner-center-img">
                                @if($theme3_product_image != null && $theme3_product_image->count()>0)
                                    <img class="b1" width="216" src="{{asset(Storage::url('uploads/product_image/'.$theme3_product_image[0]['product_images']))}}" alt="New collection" title="New collection">
                                @endif
                                @if($theme3_product_image != null &&  $theme3_product_image->count()>1)
                                    <img class="b2" width="142" src="{{asset(Storage::url('uploads/product_image/'.$theme3_product_image[1]['product_images']))}}" alt="New collection" title="New collection">
                                @endif
                            </div>
                        </div>
                                ...
                                <div class="cat-img">
                                    <a class="see-more" href="{{route('store.categorie.product',[$store->slug,$pro_categorie->name])}}">
                                        @if(!empty($pro_categorie->categorie_img) && \Storage::exists('uploads/product_image/'.$pro_categorie->categorie_img))
                                            <img width="112" src="{{asset(Storage::url('uploads/product_image/').(!empty($pro_categorie->categorie_img)?$pro_categorie->categorie_img:'default.jpg'))}}">
                                        @else
                                            <img width="112" src="{{asset(Storage::url('uploads/product_image/default.jpg'))}}">
                                        @endif
                                    </a>
                                </div>
                            </div>
