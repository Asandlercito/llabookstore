                ...
                <div class="col-lg-6 col-md-6">
                    <div class="banner-product">
                        @if(!empty($storethemesetting['header_img']) && \Storage::exists('uploads/store_logo/'.$storethemesetting['header_img']))
                            <img src="{{asset(Storage::url('uploads/store_logo/'.$storethemesetting['header_img']))}}" alt="image"/>
                        @else
                            <img src="{{asset(Storage::url('uploads/store_logo/home-banner1.png'))}}" alt="image"/>
                                                            ...
                                                            <div class="card-image py-3">
                                                                <a href="{{route('store.product.product_view',[$store->slug,$product->id])}}">
                                                                    @if(!empty($product->is_cover) && \Storage::exists('uploads/is_cover_image/'.$product->is_cover))
                                                                        <img class="img-center img-fluid" style="width:135px;" src="{{asset(Storage::url('uploads/is_cover_image/'.$product->is_cover))}}" alt="New collection" title="New collection">
                                                                    @else
                                                                        <img class="img-center img-fluid" style="width:135px;" src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}" alt="New collection" title="New collection">
                                                                    @endif
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="card-image py-3">
                                        <a href="{{route('store.product.product_view',[$store->slug,$topRatedProduct->product->id])}}">
                                            @if(!empty($pro_categorie->categorie_img) && \Storage::exists('uploads/is_cover_image/'.$topRatedProduct->product->is_cover))
                                                <img class="img-center img-fluid" style="width:135px;" src="{{asset(Storage::url('uploads/is_cover_image/'.$topRatedProduct->product->is_cover))}}" alt="New collection" title="New collection">
                                            @else
                                                <img class="img-center img-fluid" style="width:135px;" src="{{asset(Storage::url('uploads/is_cover_image/default.jpg'))}}" alt="New collection" title="New collection">
                                            @endif
