...
Route::get('/dashboard', ['as' => 'dashboard2','uses' => 'DashboardController@index',])->middleware(['XSS','auth',]);
...
Route::put('store-payment/{slug?}/userpayment', 'StoreController@userPayment');
...
Route::post('{slug?}/bank_transferinv', 'StoreController@bank_transferinv')->name('user.bank_transferinv');
Route::post('{slug?}/vdatai', 'StoreController@vdatai')->name('user.vdatai');
Route::post('{slug?}/vdatau', 'StoreController@vdatau')->name('user.vdatau');
...
Route::get('checkout/{slug?}/information', 'StoreController@CheckoutInformation')->name('checkout.information');
Route::post('information/{slug}', 'StoreController@processInformation')->name('checkout.processInformation');
Route::get('checkout/{slug?}/shipping', 'StoreController@CheckoutShipping')->name('checkout.shipping');
Route::post('shipping/{slug}', 'StoreController@processShipping')->name('checkout.processShipping');
Route::get('checkout/{slug?}/payment', 'StoreController@CheckoutPayment')->name('checkout.payment');
Route::put('checkout/{slug?}/payment', 'StoreController@CheckoutPayment');
